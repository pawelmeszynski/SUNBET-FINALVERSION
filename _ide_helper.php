...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function purge($items, $stale = true)
        {
                        /** @var \Litespeed\LSCache\LiteSpeedCache $instance */
                        return $instance->purge($items, $stale);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function purgeAll($stale = true)
        {
                        /** @var \Litespeed\LSCache\LiteSpeedCache $instance */
                        return $instance->purgeAll($stale);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function purgeTags($tags, $stale = true)
        {
                        /** @var \Litespeed\LSCache\LiteSpeedCache $instance */
                        return $instance->purgeTags($tags, $stale);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function purgeItems($items, $stale = true)
        {
                        /** @var \Litespeed\LSCache\LiteSpeedCache $instance */
                        return $instance->purgeItems($items, $stale);
        }
...
namespace  { 
            ...
            class LSCache extends \Litespeed\LSCache\LSCache {}
